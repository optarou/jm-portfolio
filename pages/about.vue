...
var careers = [
  ...
  },
  {
    ...
    detail: `中規模WEB制作会社にフロントエンドエンジニアとして所属。社内でJavaScript研修を受けた後、小中規模の静的サイトの受託制作などを担う。<br/>制作例: 大手化粧品メーカーコーポレートサイト...`
  },
  {
    start: '2016/1',
    end: '2016/5',
...
勉強会で知り合った人の企業から内定をもらう。`
  },
  {
    ...
    title: 'Dawn.Inc',
    detail: `小規模WEB制作会社に新卒入社。マークアップエンジニアとして所属。HTML/CSSでのコーディングをひたすら行う。業務内容は受託LPサイト制作や小規模コーポレートサイトのWordPress組み込みなど。社内で浸透していなかったSassの導入を提案。上京を機に外部の勉強会に積極的に参加するようになる。より技術的に成長できる環境を求め退職。`
  },
  {
    start: '2011/4',
    end: '2015/3',
